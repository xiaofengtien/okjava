...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/1.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/2.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/3.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/4.png)
...
![image.png](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/5.png)

如果我们的**强引用**不存在的话，那么 `key` 就会被回收，也就是会出现我们 `value` 没被回收，`key` 被回收，导致 `value` 永远存在，出现内存泄漏。

### `ThreadLocal.set()`方法源码详解

![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/6.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/8.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/7.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/9.png)

这里直接将数据放到该槽位即可。

**第二种情况：** 槽位数据不为空，`key`值与当前`ThreadLocal`通过`hash`计算获取的`key`值一致：

![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/10.png)

这里直接更新该槽位的数据。

**第三种情况：** 槽位数据不为空，往后遍历过程中，在找到`Entry`为`null`的槽位之前，没有遇到`key`过期的`Entry`：

![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/11.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/12.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/13.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/14.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/15.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/16.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/17.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/18.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/19.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/20.png)

我们假设`expungeStaleEntry(3)` 来调用此方法，如上图所示，我们可以看到`ThreadLocalMap`中`table`的数据情况，接着执行清理操作：

![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/21.png)

第一步是清空当前`staleSlot`位置的数据，`index=3`位置的`Entry`变成了`null`。然后接着往后探测：

![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/22.png)

执行完第二步后，index=4的元素挪到index=3的槽位中。

继续往后迭代检查，碰到正常数据，计算该数据位置是否偏移，如果被偏移，则重新计算`slot`位置，目的是让正常数据尽可能存放在正确位置或离正确位置更近的位置

![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/23.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/24.png)

接着看看具体的`resize()`方法，为了方便演示，我们以`oldTab.len=8`来举例：

![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/25.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/26.png)

**第二种情况：** `slot`位置中的`Entry.key`和要查找的`key`不一致：

![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/27.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/28.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/29.png)
...
![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/30.png)

图中的`requestId`即为我们各个系统链路关联的`traceId`，系统间互相调用，通过这个`requestId`即可找到对应链路，这里还有会有一些其他场景：

![](/Users/tianxiaofeng/Desktop/learning/JavaGuide/docs/java/multi-thread/images/thread-local/31.png)
